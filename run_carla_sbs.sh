...
# CUDA_VISIBLE_DEVICES=6 python tools/train_net.py --config-file ./configs/VERIWild/bagtricks_R50-ibn-carla.yml --eval-only  MODEL.WEIGHTS logs/veriwild/bagtricks_R50-ibn_4gpu-carla/model_final.pth
