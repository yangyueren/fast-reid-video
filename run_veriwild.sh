...
CUDA_VISIBLE_DEVICES=2 python tools/train_net.py --config-file ./configs/VERIWild/bagtricks_R50-ibn.yml --eval-only  MODEL.WEIGHTS logs/veriwild/bagtricks_R50-ibn_4gpu/model_68mAP.pth
